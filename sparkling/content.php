	...
	<div class="blog-item-wrap">
		...
		<div class="post-inner-content">
			...
			<div class="entry-summary">
				<?php the_excerpt(); ?>
				<div class="clearfix">
					<a class="btn btn-default pull-right" href="<?php the_permalink(); ?>"><?php _e( 'Read More', 'sparkling' ); ?></a>
				</div>
			</div><!-- .entry-summary -->
			<?php else : ?>
			<div class="entry-content">
				...
				<div class="clearfix">
					<a class="btn btn-default  pull-right" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php _e( 'Read More', 'sparkling' ); ?></a>
				</div>
